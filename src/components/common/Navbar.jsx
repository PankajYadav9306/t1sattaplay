          ...
          <div className="grid grid-cols-3 sm:gap-3 gap-2">
            {sattaLinks.map((link) => (
              <Link
                href={link.href}
                key={link.id}
                className="bg-gradient-to-b to-[#4f5e22] from-[#5b630d] text-center hover:-translate-y-1 flex items-center justify-center px-2 sm:px-5 md:px-6 py-2 sm:py-3 rounded cursor-pointer transition"
              >
