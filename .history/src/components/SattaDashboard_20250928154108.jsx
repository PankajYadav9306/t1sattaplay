                ...
                {monthlyChartData.map((row, rowIndex) => (
                  ...
                  >
                    ...
                    {GAMES.map((_, gameIndex) => (
                      <td
                        key={gameIndex}
                        className="border border-theme-primary px-3 py-2 hover:bg-gradient-to-b hover:from-[#ce991b] hover:to-[#d12f80] transition-colors text-center text-black text-sm"
                      >
                        {row[`game${gameIndex}`]}
                      </td>
                    ))}
